import { Basecoat, CssLoader, Node, Graph } from '@antv/x6'
import type { KeyValue, EventArgs } from '@antv/x6'
import { TransformImpl } from './transform'
import { content } from '@antv/x6-plugin-transform/es/style/raw'
import './api'

export class Transform extends Basecoat<Transform.EventArgs> implements Graph.Plugin {
...
export namespace Transform {
  ...
  export function parseOptionGroup<K extends KeyValue, S extends KeyValue = KeyValue, T = any>(
    graph: Graph,
    arg: T,
    options: S,
  ): K {
